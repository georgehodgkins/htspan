#ifndef _HTSPAN_BRENT_HPP_
#define _HTSPAN_BRENT_HPP_

/**
* John Burkardt's C++ implementation of Richard Brent's minimization
* algorithm, with cosmetic changes to make it compatible with htspan.
*
* License: GNU LGPL
* Last modified by original author: 17 July 2011
*/
...
//
//    Input, numeric_functor& F, a user-supplied c++ functor whose
...
//    Input, double T, a positive error tolerance.
//
//    Input, numeric_functor& F, the name of a user-supplied c++ functor
...
class func_wrapper : public numeric_functor {
  DoubleOfDouble* func;
public:
